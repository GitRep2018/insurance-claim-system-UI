...
export class DataService {
  ...
  getLoginUser = (email: string, password: string) => {
    ...
    return this._http.post("http://13.233.128.233:9090/insurance-claim-system/login", userObj)
  }
  ...
  claimYourInsure = (user: Users) => {
    return this._http.post("http://13.233.128.233:9090/insurance-claim-system/api/claims", user);
  }
  ...
  getAllClamis = (userId: number) => {
    return this._http.get(`http://13.233.128.233:9090/insurance-claim-system/api/users/${userId}/claims`)
  }
  ...
  approveClaim = (userId: number, obj: object) => {
    return this._http.put(`http://13.233.128.233:9090/insurance-claim-system/api/users/${userId}/claims`, obj)
  }
